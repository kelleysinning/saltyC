...
aggregated_df_ffg_filter <- subset(greaterbiomass, FFG %in% c("Scraper", "Shredder"))
...
X <- metaMDS(greaterone.nmds.ffg.filter, distance='bray', k=2, trymax=20, autotransform=FALSE, pc=FALSE, plot=FALSE)
